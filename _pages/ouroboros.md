...
about:
  ...
  body: >
    ...
    It's both a juicy story but also a scholarly treatment of the topic. It's vengeful and dark, but also scientifically accurate, eclectic, quirky, and full of hope.
    The symbol of the Ouroboros, the self-devouring snake has a long history in psychology (e.g., Carl Jung wrote about it) and to me it started representing cycles and feedback loops:
    cybernetic dysfunction theory, intergenerational trauma, cycles of abuse, BPD relationship cycles, technology development cycles, and more.
...
sections:
  ...
  - id: betrayal
    ...
    body_paragraphs:
      - >
        Psychopathology requires failure to move toward important goals, those that have priority for the person in day-to-day life and over the long term.
        The more goals that are disrupted, and the more important those goals are, the more severe the psychopathology.
